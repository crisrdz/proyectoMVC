<?php include "Head.php" ?>
  <title>Biblioteca - Alta autor</title>
</head>
<body>
  ...
  <main class="viewport-height">
    ...
    <section class="row justify-content-around m-auto my-5">
      ...
      <form action='<?php print RUTA_APP."autor/crea/"; ?>' method="POST" class="mt-3">
        <div class="mb-3">
          <label for="nombres" class="form-label">Nombres</label>
          <input type="text" class="form-control" id="nombres" name="nombres" aria-describedby="nombresAyuda">
          <div id="nombresAyuda" class="form-text">Ingresa los nombres del autor.</div>
        </div>

        <div class="mb-3">
          <label for="apellidos" class="form-label">Apellidos</label>
          <input type="text" class="form-control" id="apellidos" name="apellidos" aria-describedby="apellidosAyuda">
          <div id="apellidosAyuda" class="form-text">Ingresa los apellidos del autor.</div>
        </div>

        <div class="mb-3">
          <label for="nacimiento" class="form-label">Fecha de nacimiento</label>
          <input type="date" class="form-control" id="nacimiento" name="nacimiento" aria-describedby="nacimiento">
          <div id="nacimientoAyuda" class="form-text">Ingresa la fecha de nacimiento del autor.</div>
        </div>

        <div class="mb-3">
          <label for="nacionalidad" class="form-label">Nacionalidad</label>
          <input type="text" class="form-control" id="nacionalidad" name="nacionalidad" aria-describedby="nacionalidadAyuda">
