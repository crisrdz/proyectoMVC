<?php include "Head.php" ?>
  <title>Biblioteca - Modificar libro</title>
</head>
<body>
  ...
  <main class="viewport-height">
    ...
    <section class="row justify-content-around m-auto my-5">
      ...
      <a class="btn btn-primary position-absolute top-0 start-0 my-2 ms-3" href='<?php print RUTA_APP."libros/"; ?>'><i class="fas fa-arrow-left"></i></a>
        ...
        <form action='<?php print RUTA_APP."libros/modificar/"; ?>' method="POST" class="mt-3">
          <div class="mb-3">
            <label for="titulo" class="form-label">Titulo</label>
            <input type="text" class="form-control" id="titulo" name="titulo" aria-describedby="tituloAyuda" value="<?php print $data["titulo"]; ?>">
            <div id="tituloAyuda" class="form-text">Ingresa el título del libro.</div>
          </div>

          <div class="mb-3">
            <label for="autor" class="form-label">Autor</label>
            <input type="number" class="form-control" id="autor" name="autor" aria-describedby="autorAyuda" value="<?php print $data["autor"]; ?>">
            <div id="autorAyuda" class="form-text">Ingresa el ID del autor.</div>
          </div>

          <div class="mb-3">
            <label for="editorial" class="form-label">Editorial</label>
            <input type="number" class="form-control" id="editorial" name="editorial" aria-describedby="editorialAyuda" value="<?php print $data["editorial"]; ?>">
